...
public class ParkinManagerForTest {
    ...
    {
        _parkingManagerNum = "管理员PM001";
        for(int i=0;i<6;i++)
        {
            parkingPlaces.add(i, new ParkingPlace("停车场PPNum" + i, maxParkingNum));
        }
    ...
    {
        ParkingBoy parkingBoy = new ParkingBoy("停车仔PB001", parkingPlaces, new FirstAvailableParkingChooser());
    ...
    public void should_parkingManager_manager_two_parkingBoy()
    {
        ...
        ParkingBoy parkingBoy1 = new ParkingBoy("停车仔PB001", parkingPlacesForParkingBoy1, new FirstAvailableParkingChooser());
        ...
        ParkingBoy parkingBoy2 = new ParkingBoy("停车仔PB002", parkingPlacesForParkingBoy2, new FirstAvailableParkingChooser());
    ...
    public void should_parkingManager_manager_three_parkingBoys_and_printInfo()
    {
        ...
        parkingPlacesForParkingBoy2.add(parkingPlaces.get(3));
        parkingPlacesForParkingBoy2.add(parkingPlaces.get(4));
        ParkingBoy parkingBoy3 = new ParkingBoy("停车仔PB002", parkingPlacesForParkingBoy2, new MaxAvailableParkingChooser());
        ...
        ParkingBoy parkingBoy2 = new ParkingBoy("停车仔PB003", parkingPlacesForParkingBoy3, new FirstAvailableParkingChooser());
